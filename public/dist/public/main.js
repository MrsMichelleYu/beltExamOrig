...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h5>Edit this pet</h5>\n<div class=\"container\">\n  <div *ngFor=\"let error of errors\" class=\"error\">{{error}}</div>\n  <form (submit)=\"editPet(updatePet._id)\">\n    <div class=\"form-group\">\n      <label for=\"updatePet.name\">Pet Name</label>\n      <input type=\"text\" class=\"form-control\" id=\"updatePet.name\" name=\"updatePet.name\" [(ngModel)]=\"updatePet.name\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"updatePet.type\">Type</label>\n      <input type=\"text\" class=\"form-control\" id=\"type\" name=\"updatePet.type\" [(ngModel)]=\"updatePet.type\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"updatePet.description\">Description</label>\n      <input type=\"text\" class=\"form-control\" id=\"description\" name=\"updatePet.description\"\n        [(ngModel)]=\"updatePet.description\">\n    </div>\n    <p>Skills:</p>\n    <div class=\"form-group row\">\n      <label for=\"updatePet.skill1\" class=\"col-sm-2 col-form-label\">Skill 1:</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"skills1\" name=\"updatePet.skill1\" [(ngModel)]=\"updatePet.skill1\">\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"updatePet.skill2\" class=\"col-sm-2 col-form-label\">Skill 2:</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"skills2\" name=\"updatePet.skill2\" [(ngModel)]=\"updatePet.skill2\">\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"updatePet.skill3\" class=\"col-sm-2 col-form-label\">Skill 3:</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"skills3\" name=\"updatePet.skill3\" [(ngModel)]=\"updatePet.skill3\">\n      </div>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Edit pet</button>\n    <button [routerLink]=\"['/']\" class=\"btn btn-primary\">Cancel</button>\n  </form>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <h3>Know of a pet needing a home?</h3>\n  <div *ngFor=\"let error of errors\" id=\"error\">{{error}}</div>\n  <br>\n  <form (submit)=\"onSubmit()\">\n    <div class=\"form-group\">\n      <label for=\"newPet.name\">Pet Name</label>\n      <input type=\"text\" class=\"form-control\" id=\"name\" name=\"newPet.name\" [(ngModel)]=\"newPet.name\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"newPet.type\">Type</label>\n      <input type=\"text\" class=\"form-control\" id=\"type\" name=\"newPet.type\" [(ngModel)]=\"newPet.type\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"description\">Description</label>\n      <input type=\"text\" class=\"form-control\" id=\"description\" name=\"newPet.description\"\n        [(ngModel)]=\"newPet.description\">\n    </div>\n    <p>Skills:</p>\n    <div class=\"form-group row\">\n      <label for=\"newPet.skills1\" class=\"col-sm-2 col-form-label\">Skills 1:</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"skills1\" name=\"newPet.skill1\" [(ngModel)]=\"newPet.skill1\">\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"newPet.skills2\" class=\"col-sm-2 col-form-label\">Skills 2:</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"skills2\" name=\"newPet.skill2\" [(ngModel)]=\"newPet.skill2\">\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"newPet.skills3\" class=\"col-sm-2 col-form-label\">Skills 3:</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"skills3\" name=\"newPet.skill3\" [(ngModel)]=\"newPet.skill3\">\n      </div>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Add pet</button>\n    <button [routerLink]=\"['/']\" class=\"btn btn-primary\">Cancel</button>\n  </form>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<a [routerLink]=\"['/']\">Home</a>\n<div class=\"container\">\n  <h6>Details about {{onePet.name}}</h6>\n  <table class=\"table table-bordered\">\n    <thead>\n      <tr>\n        <th scope=\"col\">Pet type:</th>\n        <td scope=\"col\">{{onePet.type}}</td>\n      </tr>\n    </thead>\n    <tbody>\n      <tr>\n        <th scope=\"row\">Description:</th>\n        <td>{{onePet.description}}</td>\n      </tr>\n      <tr>\n        <th scope=\"row\">Skills:</th>\n        <td>\n          <ul>\n            <li>{{onePet.skill1}}</li>\n            <li>{{onePet.skill2}}</li>\n            <li>{{onePet.skill3}}</li>\n          </ul>\n        </td>\n      </tr>\n      <tr>\n        <th scope=\"row\">Likes:</th>\n        <td colspan=\"2\">{{onePet.likes}}</td>\n      </tr>\n    </tbody>\n  </table>\n  <button (click)=\"likePet(onePet._id)\" [disabled]=\"clicked\">Like this pet</button>\n  <button (click)=\"deletePet(onePet._id)\">Adopt this pet!</button>\n</div>\n");
...
/* harmony import */ var _show_show_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./show/show.component */ "./src/app/show/show.component.ts");
...
const routes = [
    { path: 'pets', component: _pets_pets_component__WEBPACK_IMPORTED_MODULE_1__["PetsComponent"] },
    { path: 'pets/new', component: _new_new_component__WEBPACK_IMPORTED_MODULE_2__["NewComponent"] },
    { path: 'pets/:id', component: _show_show_component__WEBPACK_IMPORTED_MODULE_3__["ShowComponent"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".container {\n  width: 970px;\n  margin: 0 auto;\n}\n\n.error {\n  color: red;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
let EditComponent = class EditComponent {
    constructor(httpService, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.updatePet = { name: '', type: '', description: '', skill1: '', skill2: '', skill3: '', oldName: '' };
    }
    ngOnInit() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".container {\n  width: 970px;\n  margin: 0 auto;\n}\n\n#error {\n  color: red;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".container {\n  width: 970px;\n  margin: 0 auto;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ul {\n  list-style-type: none;\n}\n\n.container {\n  width: 970px;\n  margin: 0 auto;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
module.exports = __webpack_require__(/*! /Users/michelleyu/Documents/Coding Dojo/MEAN/beltExam-orig/public/src/main.ts */"./src/main.ts");
